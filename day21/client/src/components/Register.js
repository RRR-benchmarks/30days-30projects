...
const Register = memo(function Register() {
  ...
  return <div className='div'>
          <div className='container'>
              <Darktheme />
              <h1>Register</h1>
              <input className='username' type='text' placeholder='username' ref={registerUsername}></input>
              <input className='password' type='password' placeholder='password' ref={registerPassword}></input>
